...
HD_PWD='/home/chase/github/FPGA_VHDL/misc tests/misc_tests.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log question1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source question1.tcl
